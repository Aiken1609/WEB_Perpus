...
class Buku(db.Model):
    ...
    status = db.Column(db.String(50), nullable=True)  # Status baca (e.g. 'Belum Dibaca', 'Sedang Dibaca', 'Selesai')
...
class User(db.Model):
    ...
    foto = db.Column(db.String(300), nullable=True)  # Foto Profil User
